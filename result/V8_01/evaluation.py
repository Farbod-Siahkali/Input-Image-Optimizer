...
import os
os.chdir('C:/Users/ASUS/Desktop/deep-person-reid/my_osnet') 
#%%
import torchreid
"""
version v1 is:
...
# attr_ranks = cmc_map_fromdist(query, gallery, dist_matrix['attr'], feature_mode='attr')

# ca_map on version 6.2
#  features:concat is: 0.9009757667574858
# os_map on version 6.2
#  features:{}  is: 0.6607691096946051
 
# ca_map on version 6.2
#  features:cnn is: 0.9025995050201112
# os_map on version 6.2
#  features:{}  is: 0.659593473976044
 
# ca_map on version 6.2
#  features:attr is: 0.8435097324423346
# os_map on version 6.2
#  features:{}  is: 0.48087513759889194
...
"""
#%%
main_path = 'C:/Users/ASUS/Desktop/Taarlab/Datasetes/Market-1501-v15.09.15/gt_bbox/'
path_train = 'C:/Users/ASUS/Desktop/Taarlab/Datasetes/Market-1501-v15.09.15/bounding_box_train/'
path_attr = './attributes/total_attr.npy'
...
#%%
attr_metrics = attr_evaluation(attr_net_camarket.eval(), test_loader, device, need_attr=True)
...
def metrics_print(attr_metrics, attr_colomns, metricss='accuracy'):
    n = 0
    ...
    print(idx+1, ')', 'mean_withzero', '-->', torch.mean(attr_metrics[0]).item())

def total_metrics(attr_metrics): 
    print('\n')
    for i in range(4,9):
        if i == 4:
            print(i-4, ')', 'precision_total', '-->', attr_metrics[i]) 
        elif i == 5:
            print(i-4, ')', 'recall_total', '-->', attr_metrics[i])        
        elif i == 6:
            print(i-4, ')', 'accuracy_total', '-->', attr_metrics[i])
        elif i == 7:
            print(i-4, ')', 'f1_total', '-->', attr_metrics[i])
        elif i == 8:
            print(i-4, ')', 'mean_accuracy', '-->', attr_metrics[i].item())
